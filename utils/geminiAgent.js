...
console.log(
  ...
  apiKey ? "API key is set (not showing full key)" : "Not set"
);
...
Return a JSON object with: 
      ...
      console.log(
        "API Endpoint:",
        `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${apiKey.substring(
          0,
          5
        )}...`
      );
